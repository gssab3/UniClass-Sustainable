...
class CharacterAI {
    ...
    async openWebsockets() {
        ...
        try {
            ...
            const edgeRollout = (_b = (_a = headers.get("set-cookie")) === null || _a === void 0 ? void 0 : _a.match(/edge_rollout=(\d+)/)) === null || _b === void 0 ? void 0 : _b.at(1);
            if (!edgeRollout)
    ...
    async internalFetchCharacterVoices(endpoint, query) {
        this.checkAndThrow(CheckAndThrow.RequiresAuthentication);
        const encodedQuery = encodeURIComponent(query !== null && query !== void 0 ? query : "");
...
===============================================================================`);
        ...
        if (!request.ok)
            throw Error("Invaild session token.");
